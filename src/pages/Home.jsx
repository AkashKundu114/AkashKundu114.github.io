...
/* ── Domain cards — the T-shaped narrative ─────────────────────────────── */
const domains = [
  {
    icon: '◈',
    label: 'AI & Data',
    desc: 'Training models, building pipelines, and extracting insight from raw data.',
    tags: ['Python', 'TensorFlow', 'Scikit-learn', 'Deep Learning', 'NLP', 'Pandas', 'Tableau', 'SQL'],
  ...
  },
  {
    icon: '◎',
    label: 'Backend & APIs',
    desc: 'Engineering the systems that serve data securely at scale.',
    tags: ['FastAPI', 'Spring Boot', 'Java', 'Docker', 'Redis', 'CI/CD', 'REST APIs'],
  ...
  },
  {
    ...
    tags: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'PWA'],
    ...
    <PageTransition>
        ...
        <div className="container">
          ...
          >
            ...
            <motion.div variants={fadeUp}>
              <div
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border font-mono uppercase mb-8"
                style={{
            ...
            <motion.h1
              variants={fadeUp}
              style={{ fontSize: 'clamp(2.4rem, 7vw, 5rem)', marginBottom: '1.8rem', lineHeight: 1.05 }}
            >
              Building intelligent,<br />
              <em style={{ color: 'var(--accent)', fontStyle: 'normal' }}>data-driven</em>{' '}
              applications<br />
              <span style={{ color: 'var(--muted)', fontSize: '0.75em' }}>from the model to the UI.</span>
            </motion.h1>

            {/* Sub-headline */}
            <motion.p
              variants={fadeUp}
              style={{ fontSize: '1.05rem', maxWidth: '58ch', color: 'var(--muted)', lineHeight: 1.8, marginBottom: '2.5rem' }}
            >
            ...
            >
              {[
                ...
                <div key={label}>
                  <span style={{ display: 'block', fontFamily: 'Syne, sans-serif', fontSize: '2.2rem', fontWeight: 800, color: 'var(--ink)', lineHeight: 1 }}>{num}</span>
                  <span style={{ display: 'block', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.58rem', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--muted)', marginTop: '0.3rem' }}>{label}</span>
                </div>
              ))}
            </motion.div>
          </motion.div>
      ...
      <section style={{ padding: '6rem 0', borderTop: '1px solid var(--border)' }}>
        <div className="container">
          ...
          {/* T-shaped layout — full-width AI card, two below */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>

            {/* Top card — AI & Data (the depth) */}
            <DomainCard domain={domains[0]} wide />

            {/* Bottom two — Backend + Frontend (the breadth) */}
          ...
          <p style={{ marginTop: '1.5rem', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.6rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--muted)', textAlign: 'center' }}>
            T-shaped skillset — deep expertise in AI &amp; Data, broad proficiency across the full stack
          </p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          >
            {featured.map(p => (
              ...
              >
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.58rem', letterSpacing: '0.1em', color: 'var(--muted)', marginBottom: '0.75rem' }}>
                  {p.year}
                </div>
                <h3 style={{ fontSize: '1rem', marginBottom: '0.65rem', color: 'var(--ink)', transition: 'color 0.25s', fontFamily: 'Syne, sans-serif', lineHeight: 1.25 }}>
                  {p.title}
                </h3>
                <p style={{ fontSize: '0.82rem', lineHeight: 1.7, marginBottom: '1.2rem', color: 'var(--muted)' }}>
                  {p.shortDesc}
                </p>
                ...
                <div style={{ marginTop: '1rem', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.68rem', fontWeight: 600, letterSpacing: '0.06em', color: 'var(--accent)' }}>
                  Case Study →
                </div>
              </div>
            ))}
      ...
      <style>{`
        @media (max-width: 640px) {
          .domain-row { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </PageTransition>
  )
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 6,
        padding: wide ? '2rem 2.5rem' : '1.75rem 2rem',
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.56rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: accent, marginTop: '0.2rem' }}>
