  ...
  return (
    <section className="section" style={{ paddingTop: '9rem' }} ref={ref}>
      ...
      <div className="container">
        ...
        <p className="reveal" style={{ marginBottom: '3rem', maxWidth: '50ch' }}>
          A growing collection of certifications spanning data science, cloud
          computing, AI/ML, and software engineering.
        </p>
          ...
          {allCategories.map(cat => (
            <button
              ...
              style={{
                ...
                color: active === cat ? '#080808' : 'var(--muted)',
              ...
              >
                {cert.image ? (
                  ...
                  <div style={{ textAlign: 'center', opacity: 0.3 }}>
                    ...
                    <span className="font-mono" style={{ fontSize: '0.55rem', color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
              ...
              <div style={{ padding: '1.25rem' }}>
                ...
                <div className="flex flex-wrap gap-1" style={{ marginBottom: '1rem' }}>
                  ...
                  {cert.skills.length > 3 && (
                    <span className="tech-badge">+{cert.skills.length - 3}</span>
                  )}
                </div>

                <div
                  className="inline-flex items-center gap-1 font-mono uppercase"
                  style={{ fontSize: '0.65rem', fontWeight: 600, letterSpacing: '0.06em', color: 'var(--accent)' }}
                >
                  View Certificate →
                </div>
              </div>
