    ...
    <section className="section" style={{ paddingTop: '9rem' }} ref={ref}>
      ...
      <div className="container">
        ...
        <h2 className="reveal" style={{ marginBottom: '1rem' }}>
          What I<br />
          <em style={{ color: 'var(--accent)', fontStyle: 'normal' }}>know &amp; use.</em>
        </h2>
        <p className="reveal" style={{ marginBottom: '4rem', maxWidth: '55ch' }}>
          A toolkit built through projects, coursework, and self-directed learning
          across languages, frameworks, and modern developer tooling.
        </p>
          ...
          <div key={category} className="reveal" style={{ marginBottom: '3rem' }}>
            <div className="flex items-center gap-4" style={{ marginBottom: '1rem' }}>
              <span
                ...
                style={{ fontSize: '0.62rem', letterSpacing: '0.15em', color: 'var(--muted)' }}
              >
                {category}
              </span>
