      ...
      <section className="section" style={{ paddingTop:'9rem' }} ref={ref}>
        ...
        <div className="container">
          ...
          {Object.entries(grouped).map(([cat,items]) => (
            <div key={cat} className="reveal" style={{ marginBottom:'3rem' }}>
              <div className="flex items-center gap-4" style={{ marginBottom:'1rem' }}>
                <span className="font-mono uppercase whitespace-nowrap" style={{ fontSize:'0.62rem',letterSpacing:'0.15em',color:'var(--muted)' }}>{cat}</span>
