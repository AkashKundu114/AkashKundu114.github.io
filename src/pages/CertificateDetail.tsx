        ...
        <div className="container">
          ...
          >
            <div className="reveal">
              {cert.file?.endsWith('.pdf') ? (
                ...
                <div
                  ...
                  style={{ overflow: 'hidden', cursor: 'none', marginBottom: '10px' }}
                ...
                <div
                  className="card"
                  style={{ padding: '60px 24px', textAlign: 'center', marginBottom: '10px' }}
                >
            ...
            <div style={{ position: 'sticky', top: '5rem' }}>
              ...
              <p
                className="reveal"
                style={{ fontSize: '13px', marginBottom: '24px', fontFamily: 'var(--font-mono)' }}
              >
                {cert.issuer}
              </p>
              ...
              {cert.description && (
                <div className="reveal" style={{ marginBottom: '20px' }}>
                  <p style={{ fontSize: '13px', lineHeight: 1.8, fontFamily: 'var(--font-body)' }}>
                    {cert.description}
                  </p>
                </div>
              )}
