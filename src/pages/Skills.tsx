...
const groups = [
  { name:'Languages',               icon:'{ }', color:'#AFD2FA', items:['Python','Java','JavaScript','TypeScript','SQL'] },
  { name:'AI & Data',               icon:'◈',   color:'#B9915E', items:['PyTorch','Scikit-learn','CatBoost','Computer Vision','Grad-CAM','Ollama (LLMs)','Pandas','NumPy'] },
  { name:'Backend & Infrastructure',icon:'⬡',   color:'#FEFAEF', items:['FastAPI','Node.js','Spring Boot','REST APIs','PostgreSQL','Docker','Azure','Git','CI/CD'] },
  { name:'Frontend',                icon:'◎',   color:'#AFD2FA', items:['React','Next.js','TypeScript','Tailwind CSS','Tauri','Framer Motion','PWA','Vite'] },
  { name:'Visualisation',           icon:'▦',   color:'#B9915E', items:['Tableau','Matplotlib','Seaborn'] },
]
      ...
      <section style={{ paddingTop: '88px' }} ref={ref}>
        <div className="container">
          ...
          <div className="stagger" style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
            {groups.map((g, i) => (
              <div key={g.name} className="card card-hover reveal" style={{ padding:'20px 24px', '--i':i }}>
                <div style={{ display:'flex', flexWrap:'wrap', alignItems:'center', gap:'16px' }}>
                  <div style={{ display:'flex', alignItems:'center', gap:'10px', minWidth:'210px' }}>
                    <span style={{
                      display:'inline-flex', alignItems:'center', justifyContent:'center',
                      width:'30px', height:'30px',
                      background:`${g.color}0e`, border:`1px solid ${g.color}30`,
                      borderRadius:0, fontSize:'13px', color:g.color, fontFamily:'var(--font-mono)',
                    }}>{g.icon}</span>
          ...
          <div className="reveal" style={{
            ...
            <span style={{ fontFamily:'var(--font-mono)', fontSize:'9px', color:'var(--accent)', fontWeight:700, letterSpacing:'0.1em', marginTop:'2px', whiteSpace:'nowrap' }}>NOTE//</span>
          ...
          <div className="reveal marquee-wrap" style={{ marginTop:'36px' }}>
            <div className="marquee-track">
              {[...marqueeSkills,...marqueeSkills].map((s,i) => (
                <span key={s+i} className="marquee-item" style={{
