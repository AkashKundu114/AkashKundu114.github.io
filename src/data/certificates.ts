...
export const certificates: Certificate[] = [
  ...
  },
  {
    ...
    image: '/certificates/microsoft-ml-operations-engineer.png',
    file:  '/certificates/Microsoft_Certified_Machine_Learning_Operations_Engineer_Associate.pdf',
    verifyUrl: 'https://learn.microsoft.com/en-us/users/akashkundu-6432/credentials/1ba8e6e632a47e48',
    description: 'Demonstrated mastery of machine learning operations on Azure as measured by passing the Microsoft Certified Associate exam (6485B9-9R34A8), by deploying, managing, and monitoring scalable ML models.',
  },
  {
  ...
  },
  {
    ...
    file:  '/certificates/Udemy_-_2024_Complete_Python_Bootcamp.pdf',
  ...
  },
  {
    ...
    file:  '/certificates/Udemy_-_The_Complete_2023_Web_Development_Bootcamp.pdf',
  ...
  },
  {
    ...
    image: '/certificates/udemy-red-teaming.jpg',
    file:  '/certificates/Udemy_-_Red_Teaming_Exploit_Development_with_Assembly_and_C.pdf',
    verifyUrl: 'https://ude.my/UC-0ff91b49-8f3b-4428-808f-ce187b62d910',
    description: 'Mastered offensive security and exploit development as measured by completing a 17.5-hour Udemy certification, by developing custom exploits using Assembly and C.',
  },
  {
    ...
    image: '/certificates/udemy-javascript-20-projects.jpg',
    file:  '/certificates/Udemy_-_JavaScript_20_Projects_In_20_Days.pdf',
    verifyUrl: 'https://ude.my/UC-2f1c768f-d6e2-40e5-9755-d0a5386437ae',
    description: 'Solidified front-end development skills as measured by completing a rigorous 8.5-hour coding challenge, by rapidly building and deploying 20 interactive projects using HTML, CSS, and JavaScript.',
  },
];
